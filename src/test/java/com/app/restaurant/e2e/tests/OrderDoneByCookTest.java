...
public class OrderDoneByCookTest {
    ...
    public void shouldPerformShowReportAction() {
        ...
        loginPage.setUsernameInput("mladen");
        loginPage.setPasswordInput("1234");

        loginPage.submitBtnClick();
        loginPage.submitBtnClick();

        Utilities.urlWait(driver,"http://localhost:4200/cook/orders",10);
        assertEquals("http://localhost:4200/cook/orders", driver.getCurrentUrl());
